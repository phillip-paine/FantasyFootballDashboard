...
RawPlayers <- read.csv("https://raw.githubusercontent.com/vaastav/Fantasy-Premier-League/master/data/2021-22/players_raw.csv", header = TRUE)
...
CleanedPlayers <- read.csv("https://raw.githubusercontent.com/vaastav/Fantasy-Premier-League/master/data/2021-22/cleaned_players.csv", header = TRUE)
...
IdPlayers <- read.csv("https://raw.githubusercontent.com/vaastav/Fantasy-Premier-League/master/data/2021-22/player_idlist.csv", header = TRUE)
...
for(t in teams){
  ...
  t = sub(" ", "_", t)
  assign(paste("stats", t, sep=""),read.csv(paste("https://raw.githubusercontent.com/vaastav/Fantasy-Premier-League/master/data/2021-22/understat/understat_", t, ".csv", sep = ""),
                                            header = TRUE)) 
}
